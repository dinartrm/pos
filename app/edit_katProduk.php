    ...
    <div class="card card-primary mt-3 ml-3">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name="namaKategori" class="form-control" id="exampleInputEmail1" value="<?php echo $item['nm_kategori']?>"> <!--ubah-->
            </div>
            <div class="form-group">
...
<?php 
    if (isset($_POST['submit'])) {
        ...
        $namaKategori = $_POST['nm_kategori'];//ubah
        $keterangan = $_POST['keterangan'];
       //ubah

        //jalankan method addPegawai  
        $app->updateSupplier($namaaKategori,$keterangan); //ubah
        // ridirect link
